...
from watchlist_app.api.views import ReviewCreate, ReviewDetailView, StreamPlatformSet, WatchListView, WatchDetailView, UserReview, StreamPlatformView, StreamPlatformDetailView, ReviewList
